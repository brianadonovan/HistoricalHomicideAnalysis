...
class ColorBar(BaseTraceHierarchyType):
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.scatterpolar.marker.colorbar.Titlefont
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.scatterpolar.marker.colorbar.Titlefont
        """
...
an instance of plotly.graph_objs.scatterpolar.marker.ColorBar"""
            )

        # Import validators
        # -----------------
        from plotly.validators.scatterpolar.marker import (
