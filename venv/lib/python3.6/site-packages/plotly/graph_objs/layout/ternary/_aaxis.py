...
class Aaxis(BaseLayoutHierarchyType):
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.layout.ternary.aaxis.Titlefont
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.layout.ternary.aaxis.Titlefont
        """
...
an instance of plotly.graph_objs.layout.ternary.Aaxis"""
        ...
        self._validators['separatethousands'
                        ] = v_aaxis.SeparatethousandsValidator()
