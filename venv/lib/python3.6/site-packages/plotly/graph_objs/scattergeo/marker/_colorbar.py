...
class ColorBar(BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.scattergeo.marker.colorbar.Tickfont
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.scattergeo.marker.colorbar.Titlefont
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.scattergeo.marker.colorbar.Titlefont
        """
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            display *09~15~23.46*
        tickformatstops
            plotly.graph_objs.scattergeo.marker.colorbar.Tickformat
            stop instance or dict with compatible properties
        ticklen
            Sets the tick length (in px).
        tickmode
