...
class ColorBar(BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.scatterternary.marker.colorbar.Tickfont
    ...
    def tickformat(self):
        ...
        format/blob/main/README.md#locale_format We add one item to
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.scatterternary.marker.colorbar.Titlefont
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.scatterternary.marker.colorbar.Titlefont
        """
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            at/blob/main/README.md#locale_format And for dates
            see: https://github.com/d3/d3-time-
            format/blob/main/README.md#locale_format We add one
...
an instance of plotly.graph_objs.scatterternary.marker.ColorBar"""
            )

        # Import validators
        # -----------------
        from plotly.validators.scatterternary.marker import (
            colorbar as v_colorbar
        )
