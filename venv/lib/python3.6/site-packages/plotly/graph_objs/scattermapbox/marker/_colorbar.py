...
class ColorBar(BaseTraceHierarchyType):
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of plotly.graph_objs.scattermapbox.marker.colorbar.Titlefont
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.scattermapbox.marker.colorbar.Titlefont
        """
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            display *09~15~23.46*
        tickformatstops
            plotly.graph_objs.scattermapbox.marker.colorbar.Tickfor
            matstop instance or dict with compatible properties
        ticklen
            Sets the tick length (in px).
        tickmode
...
an instance of plotly.graph_objs.scattermapbox.marker.ColorBar"""
        ...
        # Import validators
        # -----------------
        from plotly.validators.scattermapbox.marker import (
